                  ...
                  <div class="row">
                    <div class="col-lg-3 col-xs-6">
                                       ...
                                       <div class="small-box bg-aqua">
                                           <div class="inner">
                                               <h4><sup style="font-size: 20px">Rp </sup><?php echo safe_number_format($data12, $decimal, $a_decimal, $thousand).',-'; ?></h4>
                                               <p>Total Semua</p>
                                           </div>
                                           <div class="icon">
                                   ...
                                   <div class="col-lg-3 col-xs-6">
                                       ...
                                       <div class="small-box bg-yellow">
                                           <div class="inner">
                                               <h4><sup style="font-size: 20px">Rp </sup><?php echo safe_number_format($data22, $decimal, $a_decimal, $thousand).',-'; ?></h4>
                                               <p>Total Tahun Ini</p>
                                           </div>
                                           <div class="icon">
                                              <i class="ion ion-stats-bars"></i>
                    ...
                    <div class="col-lg-3 col-xs-6">
                                       ...
                                       <div class="small-box bg-green">
                                           <div class="inner">
                                               <h4><sup style="font-size: 20px">Rp </sup><?php echo safe_number_format($data32, $decimal, $a_decimal, $thousand).',-'; ?></h4>
                                               <p>Total Bulan Ini</p>
                                           </div>
                                           <div class="icon">
                                               <i class="ion ion-stats-bars"></i>
                                   ...
                                   <div class="col-lg-3 col-xs-6">
                                       ...
                                       <div class="small-box bg-red">
                                           <div class="inner">
                                               <h4><sup style="font-size: 20px">Rp </sup><?php echo safe_number_format($data42, $decimal, $a_decimal, $thousand).',-'; ?></h4>
                                               <p>Total Hari Ini</p>
                                           </div>
                                           <div class="icon">
                                               <i class="ion ion-stats-bars"></i>
...
<?php if($tahun != null || $tahun != ""){ ?>
 ...
 $jumlahbayar=$rowa['data'];
   ...
   <td><?php  echo safe_mysqli_real_escape_string($conn, safe_number_format($fill['bayar'], $decimal, $a_decimal, $thousand).',-'); ?></td>
   <td><?php  echo safe_mysqli_real_escape_string($conn, safe_number_format($fill['kembali'], $decimal, $a_decimal, $thousand).',-'); ?></td>
