    ...
    if(isset($_POST["simpan"])){
       if($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            $result=mysqli_query($conn,$sql);
               ...
               $sql2 = "insert into sale values( '$nota','$nomor','$tglnota','$duedate','$total','$diskon','$pot','$biaya','$databelitotal','$pelanggan','$kasir','0','$keterangan','$status','','')";
...
<form  method="post" id="Myform" class="form-user">
 ...
 <input type="hidden" class="form-control" id="tot" value="<?php echo $datatotal;?>" >
                ...
                <tr>
                  ...
                  <td><input type="text" class="form-control" style="background-color: #FDFD96" value="<?php echo $datatotal;?>" id="total" name="total" readonly></td>
                </tr>
                <tr>
