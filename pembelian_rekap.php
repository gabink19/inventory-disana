...
$supplier = safe_mysqli_real_escape_string($conn, $_GET["supplier"]);
$dari = safe_mysqli_real_escape_string($conn, $_GET["dari"]);
$sampai = safe_mysqli_real_escape_string($conn, $_GET["sampai"]);
    ...
    <div class="box">
        ...
        <div class="box-body">
           ...
           <div class="well well-sm">
                    <?php echo 'Total pembelian dari '.$dr.' sampai '.$sampe.' sejumlah <b>Rp '.safe_number_format($total, $decimal, $a_decimal, $thousand).',-</b> ada <b>Rp '.safe_number_format($belum, $decimal, $a_decimal, $thousand).',-</b> yang belum dibayar dari total pembelian tersebut' ; ?>
                </div>
