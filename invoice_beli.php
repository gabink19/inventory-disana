...
$sql1="INSERT INTO buy_payment VALUES('$kode','$nota','$sup','$tgl','$jml','$metode','$bank','$ket','$user','')";
...
if(isset($_POST['hutang'])){
       if($_SERVER["REQUEST_METHOD"] == "POST"){
         ...
         $sqlu = "INSERT INTO buy_hutang VALUES('$nota','$nopo','$kreditur','$tgl','$due','$jml','','$ket','$status','') ";
