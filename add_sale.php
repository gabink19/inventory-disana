  ...
  <!-- KONTEN BODY AWAL -->
    ...
    if(isset($_POST["tambah"])){
       if($_SERVER["REQUEST_METHOD"] == "POST"){
              ...
              $jumlah = (int)$jumlah;
              $modal = (float)$hargabeli * (float)$jumlah;
...
//masukan ke cart
               $sql2 = "insert into $tabeldatabase values( '$kode','$barang','$nama','$hargajual','$jumlah','$hargaakhir','$modal','')";
...
//merekam mutasi
               $sql4 = "INSERT INTO mutasi values ( '$kasir','$today','$jam','$barang','$sisaakhir','$kurang','$kegiatan','$kode','','$status')";
  ...
  <div id="main">
   <div class="container-fluid">
          ...
          <form class="form-horizontal" method="post" action="<?php echo $halaman; ?>" id="Myform" class="form-user">
              <div class="box-body">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-6 col-xs-12" >
                  <label for="tglnota" class="col-sm-4 control-label">User:</label>
                  <div class="col-sm-8">
      ...
      <input type="hidden" class="form-control" id="insert" name="insert" value="<?php echo $insert;?>" maxlength="1" >
           ...
           $sql    = "select * from $tabeldatabase where nota =".autoNumber()." order by no desc";
           $result = mysqli_query($conn, $sql);
           $rpp    = 25;
       ...
       echo safe_mysqli_real_escape_string($conn, $r['sku']); ?>
           ...
           <div align="right"><?php if($tcount>=$rpp){ echo paginate_one($reload, $page, $tpages);}else{} ?></div>
              ...
              <div class="box-footer" >
                <div class="col-sm-6">
                 <a class="btn btn-block pull-left btn-flat btn-danger" href="bayar_inv?nota=<?php echo autoNumber();?>" >SELANJUTNYA</a> 
</div>
              </div>
              <!-- /.box-footer -->
