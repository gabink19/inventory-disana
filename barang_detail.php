...
if ($chmod >= 2 || $_SESSION['jabatan'] == 'admin') {
  ...
  <!-- KONTEN BODY AWAL -->
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Detail | SKU Barang:#<?php echo $sku;?></h3>
            </div>
                                <!-- /.box-header -->
...
<!-- Profile Image -->
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <a href="stok_in?barcode=<?php echo $barcode;?>" class="btn btn-primary btn-block"><b>Tambah Stok</b></a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
...
<div class="tab-pane" id="settings">
                <form class="form-horizontal"  >
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                    <label for="inputName" class="col-sm-2 control-label">Brand/Merek</label>

                    <div class="col-sm-10">
                      <input type="text" class="form-control" value="<?php echo $data['brand'];?>" readonly="readonly" placeholder="kategori">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" value="<?php echo $data['satuan'];?>" readonly="readonly" placeholder="satuan">
                    </div>
                  </div>
...
<div class="tab-content">
    ...
    if ($search != null || $search != "") {
       ...
       <tbody>
            ...
            <td><?php  echo safe_mysqli_real_escape_string($conn, $fill['ket']); ?></td>
