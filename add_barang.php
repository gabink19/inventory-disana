...
<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST"){
     if(isset($_POST['savebarang'])){
        ...
        $result=mysqli_query($conn,$sql);
         ...
         if((($tipeavatar == "image/jpeg" || $tipeavatar == "image/png") && ($ukuranavatar <= 10000000)) && ($chmod >= 3 || $_SESSION['jabatan'] == 'admin')){
             move_uploaded_file($tmp, $avatar);
                   $sql1="UPDATE barang SET sku='$sku', nama='$nama',kategori='$kategori',hargabeli='$hargabeli',hargajual='$hargajual',stokmin='$stokmin',barcode='$barcode',brand='$brand',keterangan='$ket',lokasi='$rak',expired='$exp',warna='$warna',ukuran='$ukuran',satuan='$satuan', avatar='$avatar' WHERE kode='$kode'";
                  ...
                  echo "<script type='text/javascript'>window.location = '$forwardpage';</script>";
                   ...
                   $sql1="UPDATE barang SET sku='$sku', nama='$nama',kategori='$kategori',hargabeli='$hargabeli',hargajual='$hargajual',stokmin='$stokmin',barcode='$barcode',brand='$brand',keterangan='$ket',lokasi='$rak',expired='$exp',warna='$warna',ukuran='$ukuran',satuan='$satuan' WHERE kode='$kode'";
          ...
          move_uploaded_file($tmp, $avatar);
            $sql2 = "insert into $tabeldatabase values( '','$kode','$sku','$nama','$kategori','$brand','$barcode','$hargabeli','$hargajual','$terjual','$terbeli','$sisa','$retur','$stokmin','$ukuran','$warna','$exp','$satuan','$rak','$ket','$avatar')";
        ...
        $sql4=mysqli_query($conn,"INSERT INTO mutasi VALUES('$usr','$now','$kode','$sisa','0','menambah Produk','$kode','','berhasil')");
